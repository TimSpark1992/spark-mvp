#!/usr/bin/env python3
"""
Enhanced Validation Schema XSS Protection Testing
...
"""
    ...
    with open('/app/test_validation_schemas.js', 'w') as f:
        f.write(test_script)
    
    try:
        # Run the Node.js test script
        result = subprocess.run(
            ['node', 'test_validation_schemas.js'],
            cwd='/app',
            capture_output=True,
            text=True,
            timeout=30
        ...
        # Clean up
        if os.path.exists('/app/test_validation_schemas.js'):
            os.remove('/app/test_validation_schemas.js')
